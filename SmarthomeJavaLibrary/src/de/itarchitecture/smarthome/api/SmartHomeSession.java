...
public class SmartHomeSession implements Serializable {
	 ...
	 * @throws SHTechnicalException the sH technical exception
	 ...
	 * Switch state.
	 *
	 * @param switchActuator the switch actuator
	 * @param bOn the b on
	 * @throws SmartHomeSessionExpiredException the smart home session expired exception
	 */
	 ...
	 * Zustands variable change state.
	 *
	 * @param genericActuator the generic actuator
	 ...
	 * @param roomName the room name
	 * @param deviceName the device name
	 * @param logicalDevices the logical devices
	 * @return the logical device by room name and device name
	 */
